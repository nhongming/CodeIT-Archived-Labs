...
from test import getStudentResults
...
def submit():
    ...
    try:
        student_solutions = getStudentResults()
        data = {
            "student_answers": student_solutions,
            "repl_username": repl_username
        }
        res = requests.post("https://codeit-autograder.herokuapp.com/advanced/pset2/submit", json=data)
        ...
        print("Failed to submit work to server, error: {}".format(str(e)))
        return
